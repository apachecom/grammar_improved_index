...
#     mkdir /d1/apacheco/built-indices/pi${pi}
    ./build_indices /d1/apacheco/collections/einstein.en.txt_N0_10MB /d1/apacheco/built-indices/pi${pi}/einstein.en.txt_N0_10MB /d1/apacheco/results/mem/mem-einstein.en.txt_N0_10MB --benchmark_out=/d1/apacheco/results/build/build-einstein.en.txt_N0_10MB.csv --benchmark_out_format=csv
